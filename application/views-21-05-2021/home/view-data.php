...
<section class="searching-map">
      ...
      <div class="row">
		...
		<div class="row pb-3">
               <div class="col-3">
                  <form class="ml-5 float-right" action="<?php echo base_url();?>" method="POST" >
         ...
         <div class="col-md-4">
                  ...
                  <div  id="overview">
                     ...
                     <div class="basics">
                        <div class="factoid">
                           <h4>Parcels</h4>
                           <h4><?php if(isset($searchid['rowcount']) && $searchid['rowcount'] > 0) { echo  number_format($searchid['rowcount']);}else{
							   echo 0;
						   }?></h4>
						   <?php if(isset($searchid['rowcount']) && $searchid['rowcount']== 0) {?>
