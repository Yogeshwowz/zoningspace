                  ...
                  <div class="row align-items-end">
                     <div class="col-lg-6 mb-3 mb-lg-0">
                        <div class="pricing_box">
                           ...
                           <p>If you buy this subscription plan .we can provide 5000 connect. in which you can buy 5000 search records</p>
                     ...
                     <div class="col-lg-6 mb-3 mb-lg-0">
                        <div class="pricing_box">
                           ...
                           <p>If you buy this subscription plan .we can provide 15000 connect. in which you can buy 15000 search records and you can create 3 members</p>
                          	<?php if(empty($this->session->userdata('user_id'))){ ?>
							<button  type="button" class="payments_btn" 
							data-toggle="modal"  data-target="#pricing-popup">Get Started</button><?php }else{?>
                  ...
                  <div class="row">
                     <div class="col-lg-6 mb-3 mb-lg-0">
                        <div class="pricing_box">
                           ...
                           <p>If you buy this subscription plan .we can provide 500 connect. in which you can buy 500 search records</p>
                           <?php if(empty($this->session->userdata('user_id'))){ ?>
							<button  type="button" class="payments_btn" 
							data-toggle="modal"  data-target="#pricing-popup">Get Started</button><?php }else{?>
                     ...
                     <div class="col-lg-6 mb-3 mb-lg-0">
                        <div class="pricing_box">
                           ...
                           <p>If you buy this subscription plan .we can provide 1000 connect. in which you can buy 1000 search records and you can create 3 members</p>
                           	<?php if(empty($this->session->userdata('user_id'))){ ?>
							<button  type="button" class="payments_btn" 
							data-toggle="modal"  data-target="#pricing-popup">Get Started</button><?php }else{?>
