              ...
              <div class="box admin-box">
               ...
               <table id="example" class="display table table-hover" style="width:100%">
				...
				<?php foreach($buySearch as $buySearch){?>
					    ...
					    <td><?php 
						$getname = $this->administrator_model->getusernameById($buySearch['reseacher_id']); 
						...
						<td>
							...
							<button class="btn btn-warning assigned-reseacher" data-toggle="modal" data-target="#myAssignedReseacher" rel="<?php echo $buySearch['order_id'] ?>">Assigned Researcher</button>
							<?php } ?>
						</td>
