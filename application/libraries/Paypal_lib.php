...
class paypal_lib {
	...
	function paypal_auto_form() 
	{
		...
		echo '<html>' . "\n";
		echo '<head><title>Processing Payment...</title><style>.loader {
...
input[type="submit" i] { padding: 12px;
    color: #2c5ce4;cursor: pointer; }</style></head>' . "\n";
		echo '<body style="text-align:center; background: #4d4d4da1;" onLoad="document.forms[\'paypal_auto_form\'].submit();">' . "\n";
		echo '<p style="text-align:center; font-size: 22px; color: #fff;">Please wait, your order is being processed and you will be redirected to the paypal website.</p>' . "\n";
