		...
		<div class="row">
         <div class="col-lg-4">
                  ...
                  <div  id="overview">
                     ...
                     <p class="small-lead">
                        Select a record from available Data, add it your cart proceed for the payment. When you've chosen what you need, go to your cart to pay by card and get latest Data.
                     </p>
					<p class="small-lead">
					Download a 
					<a  download  style="color:#ed5151;" href="<?php echo base_url();?>assets/csv/sample-csv-for-washington-district-of-columbia.csv" class=" DownloadSearchlimit5"  value="Download" name="DownloadSearchlimit5"  searchid="<?php echo $searchid['search_id'] ?>"  single_record_id="<?php echo $searchid['single_record_id'] ?>" DownloadSearchlimit5="DownloadSearchlimit5">sample CSV for Washington, District of Columbia</a>
					</p>
                     <p class="small-lead">
                        Browse list of all fields available for this county. You may also explore Washington County on Zoningspace to browse fields and properties on our map.
                     </p>
                     <p class="small-lead">
