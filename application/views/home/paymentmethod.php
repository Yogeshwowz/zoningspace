...
if($subplan==1){ $amount =2500;}
if($subplan==2){ $amount =3000;}
if($subplan==3){ $amount =400;}
if($subplan==4){ $amount =600;}
?>
               ...
               <form role="form" action="<?php echo base_url(); ?>stripePost" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="<?php echo $this->config->item('stripe_key') ?>" id="payment-form">
                  <div class='form-row row py-3'>
                     ...
                     <div class='col-md-12 form-group required'>
                        <label class='control-label'>Amount  </label><input readonly 
						   ...
						   <input  type="hidden" id="subscription"  name="subscription" class='form-control' value='<?php echo $subplan;?>'>
						   
						    <input  type="hidden" id="packageamount"  name="packageamount" class='form-control' value='<?php echo $amount?>'>
                     </div>
                  ...
                  <div class="row">
                     <div class="col-md-4 mx-auto">
                        <button class="btn pay_btn mb-3" type="submit">Pay Now</button>
                     </div>
                  </div>
               </form>
         </div>
