                  ...
                  <div class="row py-2">
                     <div class="col-xl-9 col-lg-9">
                        <div class="search-background bg-transparent w-100">
                           <div class="form row">
                              <div class="col-md-2 col-2 pr-0 pr-md-3">
                                 <span>Within</span>
                              </div>
                              <div class="col-md-3 col-3 px-md-0">
                                 <input type="text" name="miles" class="search-mile form-control numberdecimalcls" placeholder="Miles" />
                              </div>
                              <div class="col-md-1 col-1 px-0 px-md-3">
                                 <span>From</span>
                              </div>
                              <div class="col-md-6 col-6 location-search">
                                 <input class="form-control input-lg autocompletegoogleaddress" id="autocomplete" name="searchboxForAddress" placeholder="Enter address" onFocus="geolocate()" value="" type="text" />
                  ...
                  <div class="modal-content">
                     ...
                     <div class="modal-footer">
                        <div class="row w-100">
                           <div class="col-md-4"></div>
                           <div class="col-md-4">
                              <button type="button" class="btn form-btn" id="">Clear Filters</button>
                           </div>
                           <div class="col-md-4">
                              <button type="button" class="btn form-btn model-next-cls enter-cls" data-dismiss="modal">
                              Enter<span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span>
