...
<section class="View-listing">
	<div class="down_loader" id="loading" style="display:none;">
         ...
         <div class="container">
			...
			data-toggle="modal" id="add_to_cart_btn" data-target="#add-to-cart-popup"><span class="title_icon"><i class="fa fa-sliders pl-1" aria-hidden="true"></i></span><span class="title_text">Buy Search</span></button>
			<button  type="button" id="save-search-popup-btn" data-toggle="modal" data-target="#save-search-popup" class="save_search"><span class="title_icon"><i class="fa fa-sliders pl-1" aria-hidden="true"></i></span><span class="title_text">Save This Search</span></button><?php }else{ 
			if(!empty($usersInformation['subscription'])){?>
				<button  type="button" class="add_to_cart" id="add_to_cart_subscription"><span class="title_icon"><i class="fa fa-sliders pl-1" aria-hidden="true"></i></span><span class="title_text">Buy Search</span></button><?php 
				} else { ?>
				<a  class="add_to_cart"  href="<?php echo base_url();?>pricing"><span class="title_icon"><i class="fa fa-sliders pl-1" aria-hidden="true"></i></span><span class="title_text">Buy Search</span></a>
			<?php } ?>
			<button type="button" id="save-search-model-id" data-toggle="modal" data-target="#save-search-model-popup" class="save_search"><span class="title_icon"><i class="fa fa-sliders pl-1" aria-hidden="true"></i></span><span class="title_text">Save This Search</span></button>
			<?php } ?>
