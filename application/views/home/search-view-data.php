...
<section class="View-listing">
	<div class="down_loader" id="loading" style="display:none;">
         ...
         <div class="container">
			...
			<button  type="button" class="add_to_cart" id="add_to_cart_subscription"><span class="title_icon"><i class="fa fa-shopping-cart" aria-hidden="true"></i></span><span class="title_text">Buy Search</span></button>
   ...
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <div class="row">
               <div class="col-md-12">
                  <p>Please <span class= "span-log login_popup_search" id="login_popup_search">LOGIN</span> to save the selected records. You can always access your saved records from your dashboard.
                  </p>
               </div>
            </div>
         </div>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <div class="row">
				...
				<div class="col-md-12" id="searchNameDiv">
			        <p>Please enter a name of this search record</p>
   ...
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <div class="row">
               <div class="col-md-12">
                  <p>Please <span class= "span-log login_popup_search">LOGIN</span> to purchase selected records.
                  </p>
               </div>
            </div>
         </div>
