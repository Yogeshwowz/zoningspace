...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBzfkh-4kbfKR77RvzJwFqo99rsI7r8BTk&libraries=places&callback=initAutocomplete" 
async defer></script>
<?php } ?>
...
google.maps.event.addDomListener(window, "load", initMap);
 ...
 <?php } ?>	
<?php if(in_array('buy-search',$furl) || in_array('purchased-data-list',$furl)  || in_array('save-search',$furl) || in_array('members',$furl)) { ?>
