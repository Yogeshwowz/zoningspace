<!--Footer Section-->
						...
						<div class="row">
							...
							<div class="col-lg-2 col-md-12">
								...
								<ul class="list-unstyled mb-0">
									...
									<li aria-haspopup="true"><a href="#"> Contact Us <span class="hmarrow"></span></a></li>
									<li aria-haspopup="true"><a href="<?php echo base_url(); ?>subscription"> Subscription <span class="hmarrow"></span></a></li>
	...
	<script src="<?php //echo base_url(); ?>/assets/plugins/cookie/cookie.js"></script>-->
		...
		<!-- Scripts Js-->
		<script src="<?php echo base_url(); ?>/assets/js/owl-carousel-rtl.js"></script>
	...
	<script src="<?php echo base_url(); ?>/assets/mysql/datepicker/datepicker.js"></script>
	  
	  <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
      <!---- End Here --------------------------------->
      <script src="<?php echo base_url(); ?>/assets/mysql/custom.js"></script>
	...
	<script src="<?php echo base_url(); ?>/assets/mysql/loading.js" defer></script>
	   <!----------------------- End here ------------------------------>
		...
		<script src="<?php echo base_url(); ?>/assets/mysql/stripe-payment.js"></script>
 <!-------Range Slider ------------------------------------------------------------->
	<link rel="stylesheet" href="<?php echo base_url(); ?>/assets/mysql/range-slider.css">
	<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
	<script src="<?php echo base_url(); ?>/assets/mysql/custom-range-slider.js"></script>
