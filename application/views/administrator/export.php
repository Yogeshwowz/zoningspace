...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-cloud-download"></i> Import Management
              ...
              <div class="box admin-box">
               ...
               <table id="example" class="display table table-hover" style="width:100%">
				...
				<?php foreach($export as $export){?>
						...
						<td>
						<a class="btn btn-success" href="<?php echo base_url();?>assets/upload/csv/<?php echo $export['fileName'] ?>">Downlaod</a>
						<input type="button" class="btn btn-primary ahrefcls importFile"  value="Import" name="Import"  filename="<?php echo $export['fileName'] ?>">
