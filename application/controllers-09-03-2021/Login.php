    ...
    public function index($page = 'register'){
        if (!file_exists(APPPATH.'views/home/'.$page.'.php')) {
            ...
            if($sendmail){
                ...
                //Set Message
                $this->session->set_flashdata('success', 'Thanks You for Registration,Your Account have been created Successfully.Please login with your valid Credentials');
                redirect('login');
            }else{
                echo 0;
            }
