...
class User extends BaseController
{
  ...
  /*  public function index()
    {
        //echo "<pre>"; print_r("Login Dashboard"); die;
    ...
    function userListing()
    {
        //echo "Test"; die;
            ...
            $this->loadViews("administrator/users", $this->global, $data, NULL);
    ...
    function editOld($userId = NULL)
    {
        ...
        //echo "<pre>"; print_r($data['userInfo']); die;
        $data['pageTitle'] = 'CodeInsect : Edit User';
        
        $this->load->view('administrator/includes/header');
        $this->load->view('administrator/editOld',$data);
        $this->load->view('administrator/includes/footer');
    ...
    function profile($active = "details")
    {
        ...
        //echo "<pre>"; print_r($this->global['pageTitle']); die;
        /*$this->load->view('administrator/includes/header');
        $this->load->view('administrator/profile',$data);
        $this->load->view('administrator/includes/footer');*/
        $this->loadViews("administrator/profile", $this->global, $data, NULL);
    }
    ...
    function changePassword($active = "changepass")
    {
        ...
        else
        {
            ...
            //echo "<pre>"; print_r($resultPas); die;
            if(empty($resultPas))
            {
